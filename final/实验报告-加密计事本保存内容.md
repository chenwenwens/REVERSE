...
![PE Explorer中确认依赖关系](./image/depends.png)
![记事本程序路径](./image/notepad.png)
...
![注入的主要代码](./image/inject.png)	
![注入进程调用](./image/injcall.png)
